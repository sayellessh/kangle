var Services = {
    ...
    defaults: {
        ...
        defaultThumbnail: 'http://www.inlandimaging.com/sites/default/files/styles/physician/public/default_images/default_doctor_silhouette.jpg',
        myProfileURL: 'http://www.inlandimaging.com/sites/default/files/styles/physician/public/default_images/default_doctor_silhouette.jpg',
        displayName: null,
        userPrefix: 'Dr. ',
        companyId: 36,
        userMood: 'cool',
    ...
    getTopics: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'getTopics', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getTopicById: function (userId, topicId, success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'getTopicById', _this.defaults.subdomainName, userId, topicId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getPrivateGroups: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'getPrivateGroups', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getPublicGroups: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'getPublicGroups', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getAlerts: function (success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'getAlerts', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    addTopic: function (userId, param, success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'addTopic', _this.defaults.subdomainName, userId];
        CoreREST.post(_this, context, param, success, failure);
    },
    addTopicHD: function (userId, param, success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'addTopicHD', _this.defaults.subdomainName, userId];
        CoreREST.post(_this, context, param, success, failure);
    },
    removeTopic: function (userId, topicId, removeUserId, success, failure) {
        var _this = Services;
        var context = [_this.context.topic, 'removeTopic', _this.defaults.subdomainName, userId, topicId, removeUserId];
    ...
    addSubscription: function (userId, topicId, param, success, failure) {
        var _this = Services;
        var context = [_this.context.subscription, 'addSubscription', _this.defaults.subdomainName, userId, topicId];
        CoreREST.post(_this, context, param, success, failure);
    },
    ...
    acceptInvite: function (userId, topicId, messageId, success, failure) {
        var _this = Services;
        var context = [_this.context.subscription, 'acceptInvite', _this.defaults.subdomainName, userId, topicId, messageId];
        CoreREST.post(_this, context, null, success, failure);
    },
    rejectInvite: function (userId, topicId, messageId, success, failure) {
        var _this = Services;
        var context = [_this.context.subscription, 'rejectInvite', _this.defaults.subdomainName, userId, topicId, messageId];
        CoreREST.post(_this, context, null, success, failure);
    },
    unsubscribeMember: function (userId, topicId, success, failure) {
        var _this = Services;
        var context = [_this.context.subscription, 'unsubscribeMember', _this.defaults.subdomainName, userId, topicId];
        CoreREST.post(_this, context, null, success, failure);
    },
    makeContributor: function (userId, topicId, success, failure) {
        var _this = Services;
        var context = [_this.context.subscription, 'makeContributor', _this.defaults.subdomainName, userId, topicId];
        CoreREST.get(_this, context, null, success, failure);
    },
    ...
    getKWUserInfo: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.user, 'getKWUserInfo', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    ...
    updateMood: function (userId, param, success, failure) {
        var _this = Services;
        var context = [_this.context.user, 'updateMood', _this.defaults.subdomainName, userId];
        CoreREST.post(_this, context, param, success, failure);
    },
    ...
    getDPUsers: function (firstName, userId, topicId, success, failure) {
        var _this = Services;
        var context = [_this.context.user, 'getDPUsers', _this.defaults.subdomainName, firstName, userId, topicId];
        CoreREST.get(_this, context, null, success, failure);
    },
    ...
    getUserFeeds: function (userId, feedId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getUserFeeds', _this.defaults.subdomainName, userId, _this.defaults.utcOffset, feedId];
        CoreREST.get(_this, context, null, success, failure);
    },
    updateFeedLikes: function (feedMasterId, userId, isLiked, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'updateFeedLikes', _this.defaults.subdomainName, feedMasterId, userId, isLiked];
        CoreREST.post(_this, context, null, success, failure);
    },
    getUserFeedAfterId: function (userId, feedId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getUserFeedAfterId', _this.defaults.subdomainName, userId, _this.defaults.utcOffset, feedId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getUserFeedsById: function (feedId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getUserFeedsById', _this.defaults.subdomainName, _this.defaults.utcOffset, feedId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getFeedByFeedMasterId: function (userId, feedMasterId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getFeedByFeedMasterId', _this.defaults.subdomainName, _this.defaults.utcOffset, feedMasterId, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getActivityStream: function (userId, feedId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getActivityStream', _this.defaults.subdomainName, userId, _this.defaults.utcOffset, feedId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getActivityStreamBeforeId: function (userId, feedId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getActivityStreamBeforeId', _this.defaults.subdomainName, userId, _this.defaults.utcOffset, feedId];
        CoreREST.get(_this, context, null, success, failure);
    },
    ...
    sendMessage: function (userId, topicId, param, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'sendMessage', _this.defaults.subdomainName, userId, topicId];
        CoreREST.post(_this, context, param, success, failure);
    },
    getMessage: function (userId, topicId, messageId, messageCount, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getMessage', _this.defaults.subdomainName, userId, topicId, messageId, _this.defaults.utcOffset, messageCount];
        CoreREST.get(_this, context, null, success, failure);
    },
    getMessageBeforeId: function (userId, topicId, messageId, messageCount, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getMessageBeforeId', _this.defaults.subdomainName, userId, topicId, messageId, _this.defaults.utcOffset, messageCount];
        CoreREST.get(_this, context, null, success, failure);
    },
    insertUserComment: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'insertUserComment', _this.defaults.subdomainName];
        CoreREST.post(_this, context, param, success, failure);
    },
    getActionMsg: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getActionMsg', _this.defaults.subdomainName, _this.defaults.utcOffset, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    markIsRead: function (userId, messageId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'markIsRead', _this.defaults.subdomainName, userId, messageId];
        CoreREST.post(_this, context, null, success, failure);
    },
    getUnReadMessagesCount: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getUnReadMessagesCount', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    ...
    getAlertTopic: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.message, 'getAlertTopic', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    ...
    getUserImportantDate: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'getUserImportantDate', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getUserEducationDetails: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'getUserEducationDetails', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getUserWorkDetails: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'getUserWorkDetails', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getUserInterestDetails: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'getUserInterestDetails', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    getUserLifeEvent: function (userId, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'getUserLifeEvent', _this.defaults.subdomainName, userId];
        CoreREST.get(_this, context, null, success, failure);
    },
    ...
    saveUserImportantDate: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserImportantDate', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserEducationDetails: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserEducationDetails', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserWorkDetails: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserWorkDetails', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserEventDetails: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserEventDetails', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserHospitals: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserHospitals', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserMembersOfDetails: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserMembersOfDetails', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserPublish: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserPublish', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserAwards: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserAwards', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserInterests: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserInterests', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
    saveUserSpecialityDetails: function (param, success, failure) {
        var _this = Services;
        var context = [_this.context.profile, 'saveUserSpecialityDetails', _this.defaults.subdomainName, Services.defaults.userId];
        CoreREST.postArray(_this, context, param, success, failure);
    },
