...
var Services = {
    ...
    getMeetingAnalytics:function (meetingId, success, failure) {
        var _this = Services, context = '';
        context = [_this.context.meeting, 'getMeetingAnalytics', _this.subdomainName, meetingId, _this.offset];
        CoreREST.get(_this, context, null, success, failure);
    },
    getAvailableMeetingforMonth: function (userId, month, year, success, failure) {
        var _this = Services, context = '';
        context = [_this.context.meeting, 'GetAvailableMeetingsForMonth', _this.subdomainName, _this.companyId, userId, month, year];
        CoreREST.get(_this, context, null, success, failure);
    },
